...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Automation/CustomMouseDrivenPathfinderAI3D")]
    public class CustomMouseDrivenPathfinderAI3D : MonoBehaviour 
	{
        [Header("Testing")]
        ...
        protected virtual void Awake()
        {
            ...
            Cam = Camera.main;
            Destination = GameObject.Find("AISphere");
        }
